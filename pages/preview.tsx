            ...
            <HStack backgroundColor="blue.100" justify="center" p="0">
                <Center justify="center" py={2}>
                    ...
                    <Box
                        ...
                        <Stack pt={0} align={'center'}>
                            <Image boxShadow={'md'} size="md" maxW="500" src="https://www.maxpixel.net/static/photo/1x/Digital-Digital-Art-Woman-Portrait-Person-Face-6064814.jpg" />
                ...
                <VStack justify="center" py={2}>
                    ...
                    <Box
                        ...
                        zIndex={1}>
                        <Stack pt={0} align={'center'}>
                            <Image boxShadow={'md'} size="sm" maxW="100" src="https://www.maxpixel.net/static/photo/1x/Digital-Digital-Art-Woman-Portrait-Person-Face-6064814.jpg" />
